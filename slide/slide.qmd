...
- https://atelierarith.github.io/AtelierArith_JuliaCon2026_talk/
- Link to slide ↓↓↓
...
- Loading `LinearAlgebra` works, but BLAS-backed matrix operations still fail
  with `` `ccall` requires the compiler ``
