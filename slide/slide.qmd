...
```{=html}
<div class="sjulia-executor" data-timeout-ms="60000" data-code="using Interact, Plots, Distributions, Random
...
- SubsetJuliaVM uses a **bundled interpreter** instead:
    bytecode stays data as `Vec<Instruction>`.
...
![](assets/area_sjulia_supports.jpg)
...
![](slide/assets/invite_friends.png)
